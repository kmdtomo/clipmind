...
import electron, { app as app$1, globalShortcut, BrowserWindow, ipcMain as ipcMain$1, clipboard, nativeImage, screen, Tray, Menu } from "electron";
...
ipcMain$1.on("get-history", (event) => {
...
ipcMain$1.on("copy-to-clipboard", (_, item) => {
...
ipcMain$1.on("delete-item", (_, itemId) => {
...
ipcMain$1.on("update-item", (_, updatedItem) => {
